 ...
 * 默认状态条件(无效)
 */
var default_statuses = "3";
var queryUrl = base+'/customer/queryInvalidCustomer';
var addUrl = base+'';
var modifyUrl = base+'';
var deleteUrl = base+'/customer/customerdetail';
...
//               { field: 'phoneNum', title: '客户手机', width: 150, align: 'center', sortable: true },
               ...
               { field: 'systemresourceReason1', title: '无效原因', width: 150, align: 'center', sortable: true },
...
function nameRender(record,value){
	...
	if(record.isPerfection=='1'){
		return '<a href=javascript:void(0) onclick=javascript:window.open("'+url+'") class="unline" style="cursor:pointer;"><font color="#28a4c9">('+ value +')(未维护)(无效)</font></a>';
	}else if(!value){
		return '<a href=javascript:void(0) onclick=javascript:window.open("'+url+'") class="unline" style="cursor:pointer;"><font color="#28a4c9">(信息未完善)(无效)</font></a>';
	}else{
		return '<a href=javascript:void(0) onclick=javascript:window.open("'+url+'") class="unline" style="cursor:pointer;"><font color="#28a4c9">'+value+'(无效)</font></a>'
	}
}
...
var reloadCustomerGrid = function(){
    ...
    if(searchDepIds!=null&&searchDepIds!=''&&(searchUserIds==null||searchUserIds=='')){
    	alert("请在右侧人员树中至少选中一项有下属人员的组织机构!");
    	return;
    }
...
//            'searchDepIds': searchDepIds,
            ...
            'systemresourceReason1': $("#status3Reason").val(),
