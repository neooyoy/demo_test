...
var queryUrl = base+'/kpinewhousedetailsController/queryWorkLoadSummary';
var addUrl = base+'';
var modifyUrl = base+'';
var deleteUrl = base+'';
...
//               { field: 'phoneNum', title: '客户手机', width: 150, align: 'center', sortable: false },
               ...
               { field: 'show_id', title: '编号', width: 150, align: 'center', sortable: false,render:jumpRender }
           ];
...
function contentRender(record,value){
	...
	if(record.actionEnum==actionEnum_2){
		ret = "房源实勘:"+value
	}
	if(record.actionEnum==actionEnum_3){
		ret = "房源跟进:"+value
	}
	...
	if(record.actionEnum==actionEnum_5){
		ret = "客户带看:"+value
	}
	if(record.actionEnum==actionEnum_6){
		ret = "客户跟进:"+value
	}else{
        return value;
    }
