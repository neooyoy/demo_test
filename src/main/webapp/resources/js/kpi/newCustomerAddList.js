...
var initUrl = base+'/kpinewcustomerdetailsController/initList';
var queryUrl = base+'/kpinewcustomerdetailsController/queryList';
var addUrl = base+'';
var modifyUrl = base+'';
var deleteUrl = base+'';
...
var actionEnum = "customer_customerAdd";
var actionEnumExtra = "customer_customerAddVirtual";
...
//               { field: 'phoneNum', title: '客户手机', width: 150, align: 'center', sortable: false },
               ...
               { field: 'customerId', title: '客户编号', width: 150, align: 'center', sortable: false,render:jumpRender }
           ];
...
function contentRender(record,value){
	var ret = "";
	if(record.actionEnum==actionEnum_4_1){
		ret = "创建客户:"+value
	}
	if(record.actionEnum==actionEnum_4_2){
		ret = "虚拟号创建客户:"+value
	}
	return ret;
}
