 ...
 * 虚拟号创建客户标识
 */
var customer_addbyvitralphone = "customer_customerAddVirtual";
/**
 * 订单分配客户标识
 */
var customer_customerAddByOrder = "customer_customerAddByOrder";
/**
 * 个人创建客户标识
 */
var customer_customerAdd = "customer_customerAdd";
/**
 * 默认条件(没有发生过完成带看)
 */
    ...
    for (var i=0; i<conditions.length; i++){
        if (conditions[i].id == 'condition_customerCreateAt'){
        	...
        	if (value != null && value != ''){
                ...
                $('#condition_is_perfection').html("客户状态：" + value_text)
            }else{
